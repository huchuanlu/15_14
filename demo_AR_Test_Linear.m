...
clc;
%%Load Data:
load('./ARDatabase/AR_dataset_unoccluded_32_32.mat');           %%AR Unoccluded
load('./ARDatabase/AR_dataset_scarf_32_32.mat');                %%AR Scarf
load('./ARDatabase/AR_dataset_sunglass_32_32.mat');             %%AR Sunglass
addpath(genpath('./BasisFunctions/'));
%
%%(0)Parameter Setting:
flag      = 1;
lambda    = 0.005;
patchNum  = [ 4 2 ];    %%PatchNum = [4 2];
options.flag       = flag;
